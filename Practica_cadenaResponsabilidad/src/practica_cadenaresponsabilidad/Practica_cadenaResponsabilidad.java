...
public class Practica_cadenaResponsabilidad {
        ...
        int op=0; // variable entera
        gerencia obj =new gerencia(); // objeto de tipo gerencia
        Personal obj1 = new Personal(obj);//recibe como sucesor un objeto tipo gerencia
        Contabilidad obj2 =new Contabilidad(obj1);//recibe como sucesor un objeto tipo personal
