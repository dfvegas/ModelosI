 ...
 * @author david
 */
public class AudiQ2 extends CarroBuilder{ // extiende la clase CarroBuilder
    
    @Override
    public String ConstruirPiezas(ServicioFactory piezas) { // sobreescribe el metodo heredado
        ServicioPiezas servicio = piezas.CrearPiezas(2); // crea las piezas utilizando el metodo de la intefaz
